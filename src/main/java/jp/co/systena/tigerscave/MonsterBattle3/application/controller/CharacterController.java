...
import jp.co.systena.tigerscave.MonsterBattle3.application.model.CharacterForm;
...
public class CharacterController
{
	// Sessionの定義
		...
		//@RequestMapping("/MonsterBattle3") // URLとのマッピング
		@RequestMapping(value="/MonsterBattle3", method = RequestMethod.GET) // URLとのマッピング
		...
		// sessionに入れる
		@RequestMapping(value="/MonsterBattle3", method = RequestMethod.POST)  // URLとのマッピング
